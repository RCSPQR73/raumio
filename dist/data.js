import {comparisons} from './comparables.js?v=20260923g';
import {t} from './locale.js?v=20260923g';
export const objects = [
 ...
 {id:'unknown',name:'TV / Wandobjekte',quantity:1,detail:'Mehrere Elemente in einem Modellteil',min:null,max:null,state:'unknown',platform:null,reason:'TV, Bilder und Leuchte sind zu einer Modellgruppe verbunden. Eine eindeutige Einzelbewertung ist deshalb nicht möglich.',query:'',nodes:[440,441,442],anchor:[-7.57,12.41,2],icon:'unknown',comparables:[]}
];
